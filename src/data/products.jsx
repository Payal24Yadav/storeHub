...
export const products = [
  ...
  { id: 15, name: 'Decorative String Lights 10m', category: 'lights-electricals', slug: 'decorative-string-lights', price: 249, originalPrice: 399, rating: 4.8, reviews: 312, stock: 75, badge: 'sale', tags: ['fairy lights', 'decoration', 'lights'], image: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=400&q=80', description: 'Beautiful warm white string lights for room decoration. Waterproof and durable.', featured: true, trending: true },
  { id: 16, name: 'Extension Board 4-Socket with USB', category: 'lights-electricals', slug: 'extension-board-4-socket', price: 349, originalPrice: 499, rating: 4.5, reviews: 178, stock: 55, badge: null, tags: ['extension', 'socket', 'electrical'], image: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?w=400&q=80', description: '4-socket extension board with 2 USB ports and surge protection.', featured: false, trending: false },
